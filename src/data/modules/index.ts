...
import { WYRMCALLING_MODULE } from './wyrmcalling.js';
import { CLASSIC_MODULE } from './classic.js';
import { HIDEOUT_MODULE } from './demo.js';

export const MODULES: Module[] = [HOLLOW_ROAD_MODULE, SUNKEN_BARROWS_MODULE, WYRMCALLING_MODULE, HIDEOUT_MODULE, CLASSIC_MODULE];
...
const SHIPPED_MODULE_IDS = new Set<string>(['hollow-road', 'sunken-barrows', 'wyrmcalling']);
