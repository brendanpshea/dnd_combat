...
| `terrain-cover-stone-a` | Cover (Low) | ![terrain-cover-stone-a](preview/terrain-cover-stone-a.png) |
| `terrain-cover-stone-b` | Cover (Rubble) | ![terrain-cover-stone-b](preview/terrain-cover-stone-b.png) |
...
| `terrain-wall-ember-b` | Wall (Cooled Lava Chunk) | ![terrain-wall-ember-b](preview/terrain-wall-ember-b.png) |
