...
export const HAS_ART = new Set<string>([
  'acolyte', 'air-elemental', 'animated-armor', 'assassin', 'azer', 'bandit',
  ...
  'ettin', 'fighter', 'fire-elemental', 'fire-giant', 'frost-giant',
  'gargoyle', 'ghast', 'ghost', 'ghoul', 'giant-ape', 'giant-badger',
