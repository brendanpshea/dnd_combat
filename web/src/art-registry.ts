...
export const HAS_ART = new Set<string>([
  ...
  'fire-giant', 'flesh-golem', 'frost-giant', 'gargoyle', 'gelatinous-cube',
  'ghast', 'ghost', 'ghoul', 'giant-ape', 'giant-badger', 'giant-boar',
  ...
  'goblin-hexer', 'goblin-warrior', 'gorgon', 'green-hag', 'green-wyrmling',
  'griffon', 'guard', 'halfling-priest', 'halfling-rogue',
  ...
  'salamander', 'satyr', 'scout', 'shadow', 'shield-guardian', 'skeleton',
  'skeleton-bonechanter', 'specter', 'sprite', 'spy', 'steam-mephit',
  'stone-giant', 'stone-golem', 'succubus', 'tiefling-knight',
