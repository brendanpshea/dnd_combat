...
export const HAS_ART = new Set<string>([
  'acolyte', 'air-elemental', 'animated-armor', 'apprentice-mage',
  'assassin', 'azer', 'azer-forgecaller', 'bandit', 'bandit-captain',
  'banshee', 'barbed-devil', 'bearded-devil', 'berserker', 'black-wyrmling',
  'blue-wyrmling', 'brown-bear', 'bugbear', 'chain-devil', 'cleric',
  'cockatrice', 'cult-fanatic', 'dire-wolf', 'dragonborn-paladin',
  'dragonborn-sorcerer', 'dretch', 'druid', 'dryad', 'dust-mephit',
  'dwarf-berserker', 'dwarf-cleric', 'earth-elemental', 'elephant',
  'elf-archer', 'elf-wizard', 'ettin', 'fighter', 'fire-elemental',
  'fire-giant', 'frost-giant', 'gargoyle', 'ghast', 'ghost', 'ghoul',
  'giant-ape', 'giant-badger', 'giant-boar', 'giant-constrictor-snake',
  'giant-crocodile', 'giant-hyena', 'giant-scorpion', 'giant-spider',
  'giant-toad', 'glabrezu', 'gladiator', 'gnoll', 'gnoll-packcaller',
  'gnome-bard', 'gnome-warden', 'goblin-boss', 'goblin-hexer',
  'goblin-warrior', 'gorgon', 'green-hag', 'green-wyrmling', 'guard',
  'halfling-priest', 'halfling-rogue', 'halfling-warrior', 'harpy',
  'hell-hound', 'hezrou', 'hill-giant', 'horned-devil', 'human-bard',
  'ice-mephit', 'imp', 'invisible-stalker', 'knight', 'kobold',
  'kobold-emberling', 'lion', 'lizardfolk', 'mage', 'magma-mephit', 'magmin',
  'mammoth', 'manticore', 'minotaur', 'mud-mephit', 'mummy', 'night-hag',
  'ogre', 'ogre-mage', 'orc', 'orc-barbarian', 'orc-shaman', 'owlbear',
  'paladin', 'priest', 'quasit', 'ranger', 'red-wyrmling', 'remorhaz',
  'rogue', 'salamander', 'satyr', 'scout', 'shadow', 'skeleton',
  'skeleton-bonechanter', 'smoke-mephit', 'specter', 'sprite', 'spy',
  'steam-mephit', 'stone-giant', 'succubus', 'tiefling-knight',
  'tiefling-warlock', 'troll', 'tyrannosaurus', 'unicorn', 'vampire-spawn',
  'veteran', 'vrock', 'water-elemental', 'white-wyrmling', 'wight',
  'will-o-wisp', 'wizard', 'wolf', 'worg', 'wraith', 'wyvern', 'young-black',
  'young-blue', 'young-green', 'young-red', 'young-white', 'zombie'
]);
