...
const SPELL_BLURB: Record<string, string> = {
  ...
  'shining-smite': 'Hold light ready. Your next melee hit adds 2d6 radiant and leaves the target glowing — every attack against it has advantage, and it cannot hide.',
  'ensnaring-strike': 'Hold vines ready. Your next hit wraps the target in grasping vines: a Strength save or restrained, taking 1d6 piercing each round until it tears free.',
  ...
  'entangle': 'Vines fill a 20-ft patch. A Strength save or restrained — and they linger, catching anyone who walks in until you drop concentration.',
  'heat-metal': 'Sears a creature in metal armour or holding a metal weapon for 2d8 fire — no attack roll, no save. A failed Constitution save leaves it swinging badly.',
  'call-lightning': 'Hold a storm cloud overhead. A bolt falls now, and another every turn you keep concentrating — 3d10 lightning, half on a Dexterity save.',
  ...
  'hypnotic-pattern': 'Everyone in a big square who fails a Wisdom save stands charmed and helpless until they are hurt or shaken awake — allies too (concentration).',
  'slow': 'Up to six foes close together: half speed, -2 AC, no reactions, and only half a turn and one attack, until a Wisdom save (concentration).',
  'spike-growth': 'Thorns fill an area: difficult ground, and 2d4 piercing for every square anyone walks or is shoved through (concentration).',
  'hideous-laughter': 'One foe falls down laughing — prone and helpless until a Wisdom save, rolled again with advantage each time it is hurt (concentration).',
  'hellish-rebuke': 'Cast by itself when something hurts you: 2d10 fire back at it, Dexterity save for half. A reaction.',
  'vampiric-touch': 'A melee spell attack for 3d6 necrotic that heals you half of it — and again on each later turn, free, while you hold it (concentration).',
