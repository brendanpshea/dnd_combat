...
100 spells — cantrips: 13, level 1: 32, level 2: 21, level 3: 15, level 4: 11, level 5: 8.
...
| 🗯️ Vicious Mockery | `vicious-mockery` | action | 1 enemy within 60 ft | — | — | — | Bard 1, Goblin Hexer, Satyr |

## Level 1

| Spell | ID | Cast | Aimed at | Conc. | Upcast | Notes | Known by |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 🐾 Animal Friendship | `animal-friendship` | action | 1 enemy within 30 ft (beast only) | — | — | — | Bard 1, Druid 1, Ranger 1, Gnome, Dryad |
| 💀 Bane | `bane` | action | 3 enemys within 30 ft | yes | — | — | Cleric 1, Warlock 1, Bard 1, Goblin Hexer |
| 🙏 Bless | `bless` | action | 3 allys within 30 ft | yes | — | — | Cleric 1, Paladin 1, Priest Acolyte, Priest |
...
| ❗ Command | `command` | action | 1 enemy within 60 ft (humanoid/fey/fiend/giant/dragon/monstrosity/aberration/elemental only) | — | — | — | Cleric 1, Bard 1, Paladin 1, Cult Fanatic |
| 💚 Cure Wounds | `cure-wounds` | action | 1 ally you can touch | — | yes | — | Cleric 1, Bard 1, Druid 1, Ranger 1, Paladin 1 |
...
| 🌱 Entangle | `entangle` | action | 5×5 burst within 90 ft | yes | — | — | Druid 1, Dryad, Ettercap Snarecaller, Druid |
...
| 🌟 Guiding Bolt | `guiding-bolt` | action | 1 enemy within 120 ft | — | yes | — | Cleric 2 |
| 🩹 Healing Word | `healing-word` | bonus | 1 ally within 60 ft | — | yes | — | Cleric 1, Bard 1, Druid 1, Priest Acolyte, Priest |
| 😈 Hellish Rebuke | `hellish-rebuke` | reaction | 1 enemy within 60 ft | — | yes | — | Warlock 1 |
| 👁️‍🗨️ Hex | `hex` | bonus | 1 enemy within 90 ft | yes | — | — | Warlock 1 |
| 🤣 Hideous Laughter | `hideous-laughter` | action | 1 enemy within 30 ft | yes | — | — | Wizard 1, Warlock 1, Bard 1 |
...
| ✨ Magic Missile | `magic-missile` | action | 3 enemys within 120 ft | — | — | — | Wizard 1, Sorcerer 1, Night Hag |
...
| 🤢 Ray of Sickness | `ray-of-sickness` | action | 1 enemy within 60 ft | — | yes | — | Wizard (scroll), Sorcerer 1, Abyssal Tiefling |
| ⛪ Sanctuary | `sanctuary` | bonus | 1 ally within 30 ft | — | — | — | Cleric 1, Priest Acolyte |
...
| 😴 Sleep | `sleep` | action | 2×2 burst within 60 ft | yes | — | — | Wizard 1, Sorcerer 1, Bard 1, Oni |
| 💥 Thunderwave | `thunderwave` | action | 15 ft cube (adjacent) | — | yes | — | Wizard 2, Sorcerer 1, Bard 1, Druid 1, Gnoll Packcaller, Druid |
...
| 🙈 Blindness | `blindness` | action | 1 enemy within 30 ft | — | — | — | Cleric 3, Wizard 3, Sorcerer 3, Bard 3 |
...
| ⛓️ Hold Person | `hold-person` | action | 1 enemy within 60 ft (humanoid only) | yes | — | — | Cleric 3, Warlock 3, Sorcerer 3, Bard 3, Druid 3, Cult Fanatic |
| 👤 Invisibility | `invisibility` | action | 1 ally you can touch | yes | — | — | Wizard 3, Warlock 3, Sorcerer 3, Bard 3, Oni, Mage |
| 💫 Lesser Restoration | `lesser-restoration` | bonus | 1 ally you can touch | — | — | — | Cleric 3, Bard 3, Druid 3, Ranger 5, Paladin 5, Priest |
...
| 🌫️ Pass without Trace | `pass-without-trace` | action | self (offered when it would reach someone) | yes | — | out of combat | Druid 3, Dryad |
...
| 🌵 Spike Growth | `spike-growth` | action | 5×5 burst within 150 ft | yes | — | — | Druid 3, Ranger 5 |
| 🔨 Spiritual Weapon | `spiritual-weapon` | bonus | an empty cell within 60 ft | yes | — | — | Cleric 3, Bard 6, Cult Fanatic |
| 💭 Suggestion | `suggestion` | action | 1 enemy within 30 ft (humanoid/fey/fiend/giant/dragon/monstrosity/aberration/elemental only) | yes | — | — | Wizard 3, Warlock 3, Sorcerer 3, Bard 3 |
| 🔗 Warding Bond | `warding-bond` | action | 1 ally you can touch | — | — | — | Cleric 3, Paladin 5 |
| 🕸️ Web | `web` | action | 5×5 burst within 60 ft | yes | — | — | Wizard 3, Sorcerer 3, Ettercap Snarecaller |
...
| ⚡ Call Lightning | `call-lightning` | action | 2×2 burst within 120 ft | yes | yes | — | Druid 5 |
| 🐺 Conjure Animals | `conjure-animals` | action | an empty cell within 60 ft | yes | yes | — | Druid 5 |
| 🚫 Counterspell | `counterspell` | reaction | self (offered when it would reach someone) | — | — | — | Wizard 5, Warlock 5, Sorcerer 5, Mage |
| 🚫 Dispel Magic | `dispel-magic` | action | 1 creature within 120 ft | — | — | — | Cleric 5, Wizard 5, Warlock 5, Sorcerer 5, Bard 5, Druid 5, Priest |
| 😱 Fear | `fear` | action | 15 ft cone | yes | — | — | Wizard 5, Warlock 5, Sorcerer 5, Bard 5 |
| 💥 Fireball | `fireball` | action | 5×5 burst within 150 ft | — | yes | — | Wizard 5, Sorcerer 5, Bard 6, Mage |
| 🐇 Haste | `haste` | action | 1 ally within 30 ft | yes | — | — | Wizard 5, Sorcerer 5 |
| 🌀 Hypnotic Pattern | `hypnotic-pattern` | action | 5×5 burst within 120 ft | yes | — | — | Wizard 5, Warlock 5, Sorcerer 5, Bard 5 |
| ⚡ Lightning Bolt | `lightning-bolt` | action | line to the board edge | — | yes | — | Wizard 5, Sorcerer 5 |
...
| ⏳ Slow | `slow` | action | 6 enemys within 120 ft | yes | — | — | Wizard 5, Sorcerer 5, Bard 5 |
| 👼 Spirit Guardians | `spiritual-guardians` | action | self (offered when it would reach someone) | yes | yes | — | Cleric 5, Priest |
| 🩸 Vampiric Touch | `vampiric-touch` | action | 1 enemy you can touch | yes | yes | — | Wizard 5, Warlock 5, Sorcerer 5 |
...
| 👁️ Phantasmal Killer | `phantasmal-killer` | action | 1 enemy within 120 ft | yes | — | — | Wizard 7, Bard 7, Night Hag |
...
| ❄️ Cone of Cold | `cone-of-cold` | action | 15 ft cone | — | yes | — | Wizard 9, Sorcerer 9, Druid 9, Mage |
