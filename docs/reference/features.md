...
92 features — class abilities, species traits, monster traits and trinket grants,
...
| Enhanced Cantrip (Evoker) | `enhanced-cantrip` | passive | — | — | read by the rules, no action of its own |
